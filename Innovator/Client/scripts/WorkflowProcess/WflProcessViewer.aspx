...
var aras = null;
var processID = <% Response.Write("'" & System.Web.Security.AntiXss.AntiXssEncoder.HtmlEncode(Request.QueryString("pid"),false) & "'") %>;
var activityID = "";
var processName = "";
...
If pid = "" Then%>
	dialogArguments = window.dialogArguments || window.frameElement.dialogArguments;
	aras = dialogArguments.aras;
	processID = dialogArguments.processID;
	activityID = dialogArguments.activityID;
	processName = dialogArguments.processName;
	<%Else%>
...
<%End If%>
	...
	<style type="text/css">
		...
		@import "../../styles/controls/toolbar.css";
