	...
	function createTree() {
		clientControlsFactory.createControl(
			...
			function (control) {
				...
				tocDom.load(topWnd.aras.getScriptsURL() + "CodeEditor/help/toc.xml");
				helpStorage = new jsHelp(topWnd.aras.getScriptsURL() + "CodeEditor/help/toc.xml"); // see jsHelp.js
				var treeXml = topWnd.aras.applyXsltFile(tocDom, topWnd.aras.getScriptsURL() + "CodeEditor/xslt/Help2Tree.xsl");
				treeGrid = control;
