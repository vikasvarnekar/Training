...
rh.consts('DEFAULT_TOPIC', encodeURI("About_PLM.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '0b24f11c-bfe0-4002-9e86-15df1f91091c' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "ProductEngineering");
