...
echo *******************************************************************
echo You are going to install the software required for the deploy agent
echo *******************************************************************
...
powershell -Command "Set-ExecutionPolicy Bypass -Scope Process -Force; & %PathToThisBatFileFolder%PowershellScripts\SetupEnvironment.ps1 -EnvironmentType 'Deploy'"
