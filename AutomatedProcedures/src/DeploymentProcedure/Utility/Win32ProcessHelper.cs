...
namespace DeploymentProcedure.Utility
{
	public static class Win32ProcessHelper
	{
		...
		{
			return TerminateProcess(process.Handle, ERROR_PROCESS_ABORTED);
		}
		...
		//according to the https://docs.microsoft.com/en-us/windows/win32/debug/system-error-codes--1000-1299-
		//1067	stands for 'The process terminated unexpectedly.'
		const uint ERROR_PROCESS_ABORTED = 1067;
